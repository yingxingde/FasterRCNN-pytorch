...
# from lib.nms.py_cpu_nms import py_cpu_nms as nms
...
def test_net(net, imdb, resume_iter, model_dir, output_dir, max_per_image=100, thresh=0.):
  solver = SolverWrapper(network=net, imdb=imdb, model_dir=model_dir, output_dir=output_dir)
  solver.test_model(resume_iter, max_per_image, thresh)
